    ...
    private func getObject(entity: Storable, type: String, parent: NSManagedObject? = nil) -> NSManagedObject?  {
        ...
        case "ForecastModel":
            ...
            if let entity = entity as? Forecast {
                ...
                var dayPartsModel = Set<DayPartsModel>()
                
                var part = getObject(entity: entity.dayForecast!, type: "DayPartsModel", parent: object) as! DayPartsModel
                dayPartsModel.insert(part)
                
                part = getObject(entity: entity.nightForecast!, type: "DayPartsModel", parent: object)  as! DayPartsModel
                dayPartsModel.insert(part)
                
                object.setValue(dayPartsModel, forKey: "dayparts")
        ...
        self.fetchModel(predicate: predicate) { [weak self] result in
            ...
            case .success(let fetchedObjects):
                ...
                self.saveContext.perform {
                    ...
                    let citys = fetchedObjects.map { cityModel in
